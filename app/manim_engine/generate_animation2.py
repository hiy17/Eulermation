...
class AnimatedEulerianGraph(EulerGraphBase):
    def __init__(
        self,
        speed=0.5,
    ...
    def construct(self):
        ...
        G_nx, eulerCircuits = generator.generate_eulerian_graph()
        if G_nx is None:
            return
        
        # Update the shared variables in the parent class
        self.eulerian_graph = G_nx
        self.euler_circuits = eulerCircuits

        print(f"Eulerian Graph: {self.eulerian_graph}")
...
class EulerCircuitAnimator(EulerGraphBase):
    def __init__(
        self,
        speed=0.5,
