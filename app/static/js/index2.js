    ...
    generateBtn.addEventListener('click', function() {
        ...
        fetch(`/render/eulerian_graph?vertices=${value}`, {
            ...
            .then((data) => {
                ...
                // Instead of just setting text content, animate the path
            ...
            .then(() => {
                ...
                video.setAttribute("width", "467");
                video.setAttribute("height", "300");
                video.setAttribute("style", "background: #000; border: 2px solid var(--primary); border-radius: 10px; padding: 4px;");
